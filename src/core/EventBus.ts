...
interface EventMap {
  ...
  'building:completed': { entityId: number; playerId: number; typeName?: string };
  ...
  'combat:hit': { entityId: number; x: number; z: number; damage: number; targetOwner: number; attackerOwner: number };
